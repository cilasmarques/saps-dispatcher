...
public class SubmissionDispatcher {
  ...
  public static final String LANDSAT_IMAGES_FILE_PATH_KEY = "LANDSAT_IMAGES_FILE_PATH";
  ...
  public List<String> addTasks(
    ...
    String imagesFilePath = System.getProperty(LANDSAT_IMAGES_FILE_PATH_KEY);
    ...
    // O método esta aqui pois a incrementação da data é feita aqui
    // TODO: Talvez seja interessante criar threads para paralelizar o processamento
